...
.method public final decodeFromString(Lkotlinx/serialization/DeserializationStrategy;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 1
    new-instance v0, Lkotlinx/serialization/json/internal/JsonLexer;

    invoke-direct {v0, p2}, Lkotlinx/serialization/json/internal/JsonLexer;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p2, p0, v1, v0}, Lkotlinx/serialization/json/internal/StreamingJsonDecoder;-><init>(Lkotlinx/serialization/json/Json;Lkotlinx/serialization/json/internal/WriteMode;Lkotlinx/serialization/json/internal/JsonLexer;)V
    ...
    :cond_0
    const-string p0, "Expected EOF, but had "
    ...
    iget-object p1, v0, Lkotlinx/serialization/json/internal/JsonLexer;->source:Ljava/lang/String;

    iget p2, v0, Lkotlinx/serialization/json/internal/JsonLexer;->currentPosition:I
    ...
    .line 6
    iget p1, v0, Lkotlinx/serialization/json/internal/JsonLexer;->currentPosition:I

    invoke-virtual {v0, p0, p1}, Lkotlinx/serialization/json/internal/JsonLexer;->fail(Ljava/lang/String;I)Ljava/lang/Void;
...
.method public final encodeToString(Lkotlinx/serialization/SerializationStrategy;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v4, v0, p0}, Lkotlinx/serialization/json/internal/Composer;-><init>(Lcom/google/android/play/core/assetpacks/zzdg;Lkotlinx/serialization/json/Json;)V

    invoke-direct {v1, v4, p0, v2, v3}, Lkotlinx/serialization/json/internal/StreamingJsonEncoder;-><init>(Lkotlinx/serialization/json/internal/Composer;Lkotlinx/serialization/json/Json;Lkotlinx/serialization/json/internal/WriteMode;[Lkotlinx/serialization/json/JsonEncoder;)V
    ...
    .line 7
    invoke-virtual {v0}, Lcom/google/android/play/core/assetpacks/zzdg;->toString()Ljava/lang/String;
    ...
    .line 8
    invoke-virtual {v0}, Lcom/google/android/play/core/assetpacks/zzdg;->release()V
