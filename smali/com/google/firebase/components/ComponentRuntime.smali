...
.method public constructor <init>(Ljava/util/concurrent/Executor;Ljava/lang/Iterable;Ljava/util/Collection;Lcom/google/firebase/components/ComponentRuntime$1;)V
    ...
    .line 1
    invoke-direct {p0, p4}, Lcom/google/android/gms/internal/mlkit_vision_barcode/zzbw;-><init>(I)V
    ...
    .line 15
    :cond_2
    iput-object p3, p0, Lcom/google/firebase/components/ComponentRuntime;->unprocessedRegistrarProviders:Ljava/util/List;
    ...
    .line 22
    invoke-interface {p4}, Lcom/google/firebase/components/ComponentRegistrar;->getComponents()Ljava/util/List;
    ...
    .line 26
    :cond_4
    iget-object p3, p0, Lcom/google/firebase/components/ComponentRuntime;->components:Ljava/util/Map;
    ...
    iget-object p4, p0, Lcom/google/firebase/components/ComponentRuntime;->components:Ljava/util/Map;
    ...
    .line 30
    invoke-static {p3}, Lcom/google/firebase/components/CycleDetector;->detect(Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, p4}, Lcom/google/firebase/components/ComponentRuntime$$Lambda$1;-><init>(Lcom/google/firebase/components/ComponentRuntime;Lcom/google/firebase/components/Component;)V
    ...
    .line 36
    :cond_6
    invoke-virtual {p0, p1}, Lcom/google/firebase/components/ComponentRuntime;->processInstanceComponents(Ljava/util/List;)Ljava/util/List;
...
.method public final doInitializeEagerComponents(Ljava/util/Map;Z)V
    ...
    .line 8
    :try_start_0
    iget-object p1, p0, Lcom/google/firebase/components/EventBus;->pendingEvents:Ljava/util/Queue;
    ...
    .line 9
    iput-object p2, p0, Lcom/google/firebase/components/EventBus;->pendingEvents:Ljava/util/Queue;
    ...
    .line 23
    new-instance v4, Lcom/google/android/play/core/assetpacks/zzdl;

    invoke-direct {v4, v2, v0}, Lcom/google/android/play/core/assetpacks/zzdl;-><init>(Ljava/util/Map$Entry;Lcom/google/firebase/events/Event;)V
...
.method public final processDependencies()V
    ...
    sget-object v7, Lcom/google/firebase/components/OptionalProvider$$Lambda$5;->instance:Lcom/google/firebase/components/OptionalProvider$$Lambda$5;

    invoke-direct {v5, v6, v7}, Lcom/google/firebase/components/OptionalProvider;-><init>(Lcom/google/firebase/inject/Deferred$DeferredHandler;Lcom/google/firebase/inject/Provider;)V
...
.method public final processSetComponents()Ljava/util/List;
    ...
    .line 20
    new-instance v5, Lcom/google/android/gms/common/api/internal/zabz;

    invoke-direct {v5, v3, v4}, Lcom/google/android/gms/common/api/internal/zabz;-><init>(Lcom/google/firebase/components/LazySet;Lcom/google/firebase/inject/Provider;)V
