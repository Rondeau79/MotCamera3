...
.method public buildRequest(Ljava/lang/String;I)Ljava/lang/String;
    ...
    const-string v13, "sn-special-chromatix"
    ...
    .line 65
    new-instance v4, Lcom/motorola/camera/camerax_extensions/ExposureBracketUtil$ExposureInfo;

    invoke-direct {v4}, Lcom/motorola/camera/camerax_extensions/ExposureBracketUtil$ExposureInfo;-><init>()V
    ...
    .line 67
    iget-wide v4, v7, Lcom/motorola/camera/camerax_extensions/ExposureBracketUtil$ExposureInfo;->expTimeNs:D
    ...
    :cond_11
    :goto_9
    const-wide v14, 0x41c1e1a300000000L    # 6.0E8
    ...
    .line 73
    iget-wide v3, v6, Lcom/motorola/camera/camerax_extensions/ExposureBracketUtil$ExposureInfo;->gain:D
    ...
    :goto_a
    cmpl-double v7, v23, v49

    if-lez v7, :cond_17

    div-double v23, v23, v49
    ...
    sub-double v51, v1, v22

    cmpl-double v7, v51, v14

    if-lez v7, :cond_15

    sub-double v1, v1, v49

    goto :goto_b

    :cond_15
    add-double v22, v1, v22

    mul-double v22, v22, v3

    cmpg-double v7, v22, v14

    if-gez v7, :cond_16

    add-double v1, v1, v49

    :cond_16
    :goto_b
    move-wide/from16 v23, v1

    div-double v1, v14, v23
    ...
    .line 79
    iget-wide v3, v6, Lcom/motorola/camera/camerax_extensions/ExposureBracketUtil$ExposureInfo;->expTimeNs:D

    cmpl-double v9, v23, v3
    ...
    .line 82
    iput-wide v3, v9, Lcom/motorola/camera/camerax_extensions/ExposureBracketUtil$ExposureInfo;->boost:D

    .line 83
    iput-wide v7, v9, Lcom/motorola/camera/camerax_extensions/ExposureBracketUtil$ExposureInfo;->expTimeNs:D
    ...
    .line 95
    invoke-static {v13, v4, v14}, Lcom/motorola/camera/camerax_extensions/ExposureBracketUtil;->constructBracketingRequest(Lorg/json/JSONObject;Lcom/motorola/camera/camerax_extensions/ExposureBracketUtil$ExposureInfo;F)Z
    ...
    const-string v18, "NOISE_REDUCTION_MODE"

    const-string v8, "EDGE_MODE"
    ...
    sget-object v12, Landroid/hardware/camera2/CaptureRequest;->EDGE_MODE:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    invoke-static/range {v7 .. v12}, Lcom/motorola/camera/camerax_extensions/ArcsoftHdrExtension$$ExternalSyntheticOutline0;->m(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/String;ILcom/motorola/camera/camerax_extensions/JsonUtils;Lorg/json/JSONObject;Landroid/hardware/camera2/CaptureRequest$Key;)V
    ...
    invoke-virtual {v4, v13, v7, v8}, Lcom/motorola/camera/camerax_extensions/JsonUtils;->buildJsonRequest(Lorg/json/JSONObject;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V

    .line 102
    iget-object v7, v0, Lcom/motorola/camera/camerax_extensions/ArcsoftSupernightExtension;->characteristics:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v13, v7}, Lcom/motorola/camera/camerax_extensions/ExposureBracketUtil;->setFastCaptureIfAvailable(Lorg/json/JSONObject;Landroid/hardware/camera2/CameraCharacteristics;)V
...
.method public configureStream(Landroid/view/Surface;I)Landroid/view/Surface;
    ...
    .line 3
    :cond_1
    iget-object p2, p0, Lcom/motorola/camera/camerax_extensions/ArcsoftSupernightExtension;->jsonConfig:Lorg/json/JSONObject;
    ...
    iget v5, p0, Lcom/motorola/camera/camerax_extensions/ArcsoftSupernightExtension;->inputFrameCount:I
...
.method public getExtensionConfig()Ljava/lang/String;
    ...
    .line 3
    iget v2, v0, Lcom/motorola/camera/camerax_extensions/ArcsoftSupernightExtension;->inputFrameCount:I
    ...
    .line 7
    iget-object v0, v0, Lcom/motorola/camera/camerax_extensions/ArcsoftSupernightExtension;->characteristics:Landroid/hardware/camera2/CameraCharacteristics;
    ...
    .line 36
    sget-object v16, Landroid/hardware/camera2/CaptureResult;->LENS_APERTURE:Landroid/hardware/camera2/CaptureResult$Key;
