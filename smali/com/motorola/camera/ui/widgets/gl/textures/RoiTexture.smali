...
.field public mRectRoi:Landroidx/transition/ViewOverlayApi18;
...
# virtual methods
.method public applyActiveBarAnimation(Z)V
    .locals 10
...
.method public applyCenterRoiAnimation()V
    .locals 9
    ...
    .line 2
    invoke-virtual {p0, v0, v1}, Lcom/motorola/camera/ui/widgets/gl/textures/RoiTexture;->getShowAnimation(J)Lcom/motorola/camera/ui/widgets/gl/animations/GeneralAnimation;

    move-result-object v2

    .line 3
    invoke-virtual {p0, v0, v1}, Lcom/motorola/camera/ui/widgets/gl/textures/RoiTexture;->getHideAnimation(J)Lcom/motorola/camera/ui/widgets/gl/animations/GeneralAnimation;
    ...
    invoke-direct {v1, v3, v4}, Lcom/motorola/camera/ui/widgets/gl/animations/SequenceAnimation;-><init>(Lcom/motorola/camera/ui/widgets/gl/animations/Animation$AnimationCallback;I)V

    .line 5
    iget-object v3, v1, Lcom/motorola/camera/ui/widgets/gl/animations/SequenceAnimation;->mAnimationsList:Ljava/util/LinkedList;

    invoke-virtual {v3, v2}, Ljava/util/LinkedList;->addLast(Ljava/lang/Object;)V

    .line 6
    iget-object v2, v1, Lcom/motorola/camera/ui/widgets/gl/animations/SequenceAnimation;->mAnimationsList:Ljava/util/LinkedList;
    ...
    invoke-virtual {v1, v0, v4}, Lcom/motorola/camera/ui/widgets/gl/animations/SequenceAnimation;->startAnimation([Lcom/motorola/camera/ui/widgets/gl/textures/Texture;I)V
...
.method public applyLockedAnimation(Z)V
    .locals 11
...
.method public applyShowAnimation()V
    .locals 4
    ...
    .line 3
    invoke-virtual {p0, v2, v3}, Lcom/motorola/camera/ui/widgets/gl/textures/RoiTexture;->getShowAnimation(J)Lcom/motorola/camera/ui/widgets/gl/animations/GeneralAnimation;
...
.method public getRect()Landroidx/transition/ViewOverlayApi18;
    ...
    invoke-direct {v1, v4, v5, v2, v0}, Landroidx/transition/ViewOverlayApi18;-><init>(FFFF)V

    return-object v1
.end method

.method public final getShowAnimation(J)Lcom/motorola/camera/ui/widgets/gl/animations/GeneralAnimation;
    .locals 9
...
.method public onChangePosition(Landroid/graphics/PointF;)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/motorola/camera/ui/widgets/gl/textures/RoiTexture;->updateNewRect(FF)Landroidx/transition/ViewOverlayApi18;
...
.method public onDrag(ZLandroid/graphics/PointF;Landroid/graphics/PointF;Lcom/motorola/camera/ui/widgets/gl/Vector3F;JJZ)V
    ...
    invoke-virtual {p0, p3, p4}, Lcom/motorola/camera/ui/widgets/gl/textures/RoiTexture;->updateNewRect(FF)Landroidx/transition/ViewOverlayApi18;
    ...
    .line 4
    :cond_1
    invoke-virtual {p0}, Lcom/motorola/camera/ui/widgets/gl/textures/RoiTexture;->getRect()Landroidx/transition/ViewOverlayApi18;
    ...
    invoke-virtual {p3}, Landroidx/transition/ViewOverlayApi18;->centerX()F

    move-result p5

    invoke-virtual {p3}, Landroidx/transition/ViewOverlayApi18;->centerY()F

    move-result p3

    const/4 p6, 0x0

    invoke-direct {p4, p5, p3, p6}, Lcom/motorola/camera/ui/widgets/gl/Vector3F;-><init>(FFF)V

    invoke-interface {p2, p1, p4}, Lcom/motorola/camera/ui/widgets/gl/textures/RoiTexture$RoiCallback;->onDrag(ZLcom/motorola/camera/ui/widgets/gl/Vector3F;)V
...
.method public setFocusExposeLocked(ZZ)V
    .locals 11
    ...
    invoke-virtual {p1, p0, v1, v1, p2}, Lcom/motorola/camera/ui/widgets/gl/textures/Texture;->setPreRotation(FFFF)V
...
.method public updateNewRect(FF)Landroidx/transition/ViewOverlayApi18;
    .locals 8
    ...
    .line 6
    new-instance v4, Landroidx/transition/ViewOverlayApi18;
    ...
    invoke-direct {v4, v5, v6, p1, p2}, Landroidx/transition/ViewOverlayApi18;-><init>(FFFF)V
    ...
    .line 8
    :cond_0
    invoke-interface {p1}, Lcom/motorola/camera/ui/widgets/gl/textures/RoiTexture$RoiCallback;->getTouchBoundaryRect()Landroidx/transition/ViewOverlayApi18;
    ...
    invoke-virtual {v4}, Landroidx/transition/ViewOverlayApi18;->width()F
    ...
    iget-object v5, v4, Landroidx/transition/ViewOverlayApi18;->mViewOverlay:Ljava/lang/Object;
    ...
    iget-object v2, v4, Landroidx/transition/ViewOverlayApi18;->mViewOverlay:Ljava/lang/Object;
    ...
    .line 13
    :goto_1
    iget-object v5, p1, Landroidx/transition/ViewOverlayApi18;->mViewOverlay:Ljava/lang/Object;

    check-cast v5, Landroid/graphics/RectF;

    iget v5, v5, Landroid/graphics/RectF;->top:F

    invoke-virtual {v4}, Landroidx/transition/ViewOverlayApi18;->height()F
    ...
    iget-object v6, v4, Landroidx/transition/ViewOverlayApi18;->mViewOverlay:Ljava/lang/Object;
    ...
    .line 17
    :goto_3
    iget-object v3, v4, Landroidx/transition/ViewOverlayApi18;->mViewOverlay:Ljava/lang/Object;
    ...
    .line 24
    :try_start_0
    iput-object v4, p0, Lcom/motorola/camera/ui/widgets/gl/textures/RoiTexture;->mRectRoi:Landroidx/transition/ViewOverlayApi18;

    .line 25
    invoke-virtual {v4}, Landroidx/transition/ViewOverlayApi18;->centerX()F

    move-result p1

    iget-object v2, p0, Lcom/motorola/camera/ui/widgets/gl/textures/RoiTexture;->mRectRoi:Landroidx/transition/ViewOverlayApi18;

    invoke-virtual {v2}, Landroidx/transition/ViewOverlayApi18;->centerY()F
    ...
    invoke-virtual {v4}, Landroidx/transition/ViewOverlayApi18;->centerY()F
    ...
    invoke-static {v0}, Landroidx/constraintlayout/core/SolverVariable$Type$r8$EnumUnboxingUtility;->getmX$$com$motorola$camera$ui$widgets$gl$textures$RoiTexture$BarPos(I)F
