.class public Lcom/motorola/camera/jms/BgJobTransferService;
...
.field public final mPendingTransferJobs:Ljava/util/Map;
...
.field public final mTransferJmsList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Long;",
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mTransferJmsList:Ljava/util/List;
    ...
    iput-object v2, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mPendingTransferJobs:Ljava/util/Map;
    ...
    new-instance v4, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda8;

    invoke-direct {v4, p0}, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda8;-><init>(Lcom/motorola/camera/jms/BgJobTransferService;)V
...
.method public constructor <init>(Lcom/motorola/camera/jms/BgJobTransferService$1;)V
    .locals 6
    ...
    iput-object p1, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mTransferJobListener:Ljava/util/Set;

    const/4 p1, 0x0

    .line 19
    iput p1, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mJobRefCount:I
    ...
    iput-object v0, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mTransferJmsList:Ljava/util/List;
    ...
    iput-object v1, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mPendingTransferJobs:Ljava/util/Map;

    .line 22
    new-instance v1, Lcom/motorola/camera/background/common/SimpleWatchDog;

    const-string v2, "BgJobTransferService Watchdog"

    new-instance v3, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda8;

    invoke-direct {v3, p0}, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda8;-><init>(Lcom/motorola/camera/jms/BgJobTransferService;)V

    const-wide/16 v4, 0x4e20

    invoke-direct {v1, v2, v4, v5, v3}, Lcom/motorola/camera/background/common/SimpleWatchDog;-><init>(Ljava/lang/String;JLjava/lang/Runnable;)V

    iput-object v1, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mJobMgrServiceWatchDog:Lcom/motorola/camera/background/common/SimpleWatchDog;
    ...
    const-string v0, "jms_job_handler"

    invoke-direct {p1, v0}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object p1, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mJmsHandlerThread:Landroid/os/HandlerThread;
    ...
    iget-object v0, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mJmsHandlerThread:Landroid/os/HandlerThread;
    ...
    invoke-direct {v1, p0}, Lcom/motorola/camera/jms/BgJobTransferService$$ExternalSyntheticLambda0;-><init>(Lcom/motorola/camera/jms/BgJobTransferService;)V

    invoke-direct {p1, v0, v1}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object p1, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mJmsJobHandler:Landroid/os/Handler;
...
.method public static processBgJob(Lcom/motorola/camera/fsm/camera/record/SequenceIdentifier;Lcom/motorola/camera/jms/BgJobManager$BgJobHolder;Lcom/motorola/camera/background/common/TaskId;)V
    ...
    invoke-direct {v2, p0, p1, p2}, Landroidx/room/QueryInterceptorDatabase$$ExternalSyntheticLambda3;-><init>(Lcom/motorola/camera/fsm/camera/record/SequenceIdentifier;Lcom/motorola/camera/jms/BgJobManager$BgJobHolder;Lcom/motorola/camera/background/common/TaskId;)V

    .line 3
    iget-object p0, v0, Lcom/motorola/camera/jms/BgJobTransferService;->mPendingTransferJobs:Ljava/util/Map;

    monitor-enter p0

    .line 4
    :try_start_0
    iget-object p1, v0, Lcom/motorola/camera/jms/BgJobTransferService;->mPendingTransferJobs:Ljava/util/Map;
...
.method public final declared-synchronized incJobRefCount(Ljava/lang/Long;)V
    ...
    .line 2
    iget-object v0, p0, Lcom/motorola/camera/jms/BgJobTransferService;->mTransferJmsList:Ljava/util/List;
