...
# instance fields
.field public final mAvailabilityListener:Lcom/motorola/camera/device/callables/AvailabilityListener;

.field public final mCameraServiceHandler:Landroid/os/Handler;


# direct methods
.method public constructor <init>(Lcom/motorola/camera/device/callables/CameraListener;Lcom/motorola/camera/device/callables/AvailabilityListener;Landroid/os/Handler;Landroid/os/Handler;)V
    .locals 1
    ...
    .line 3
    iput-object p2, p0, Lcom/motorola/camera/device/callables/AddOrRemoveAvailabilityListenerCallable;->mAvailabilityListener:Lcom/motorola/camera/device/callables/AvailabilityListener;
...
.method public call()Lcom/airbnb/lottie/model/MutablePair;
    ...
    .line 4
    iget-object v2, p0, Lcom/motorola/camera/device/callables/AddOrRemoveAvailabilityListenerCallable;->mAvailabilityListener:Lcom/motorola/camera/device/callables/AvailabilityListener;
    ...
    .line 6
    iput-object v1, v0, Lcom/motorola/camera/device/CameraHandlerThread$CameraData;->mAvailabilityCallback:Landroid/hardware/camera2/CameraManager$AvailabilityCallback;
    ...
    .line 8
    :cond_0
    iget-object p0, v0, Lcom/motorola/camera/device/CameraHandlerThread$CameraData;->mAvailabilityCallback:Landroid/hardware/camera2/CameraManager$AvailabilityCallback;
    ...
    .line 9
    iput-object v3, v0, Lcom/motorola/camera/device/CameraHandlerThread$CameraData;->mAvailabilityCallback:Landroid/hardware/camera2/CameraManager$AvailabilityCallback;

    .line 10
    :goto_0
    new-instance p0, Lcom/airbnb/lottie/model/MutablePair;

    invoke-direct {p0, v3}, Lcom/airbnb/lottie/model/MutablePair;-><init>(Ljava/lang/Object;)V
