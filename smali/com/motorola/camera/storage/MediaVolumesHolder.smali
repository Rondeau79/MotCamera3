...
.method public static final access$updateFreeBytes(Lcom/motorola/camera/storage/MediaVolumesHolder;Lcom/motorola/camera/storage/MediaVolume;)V
    .locals 4

    .line 1
    invoke-virtual {p1}, Lcom/motorola/camera/storage/MediaVolume;->getStorageVolumeUuid()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/motorola/camera/storage/MediaVolumesHolder;->getContext()Landroid/content/Context;
    ...
    .line 4
    :try_start_1
    invoke-virtual {v2, p0}, Landroid/app/usage/StorageStatsManager;->getFreeBytes(Ljava/util/UUID;)J
    ...
    :cond_1
    :goto_1
    invoke-static {p1}, Lcom/motorola/camera/storage/MediaVolumesHolder;->getPathFile(Lcom/motorola/camera/storage/MediaVolume;)Ljava/io/File;
    ...
    :catch_2
    :goto_2
    sget-object p0, Lcom/motorola/camera/storage/MediaVolumesHolder;->freeBytesMap:Ljava/util/Map;

    const-string v2, "freeBytesMap"
    ...
    .line 9
    new-instance v0, Lcom/motorola/camera/storage/MediaVolumesHolder$notifyFreeBytesUpdatedListeners$$inlined$runOnWorker$1;

    invoke-direct {v0, p1}, Lcom/motorola/camera/storage/MediaVolumesHolder$notifyFreeBytesUpdatedListeners$$inlined$runOnWorker$1;-><init>(Lcom/motorola/camera/storage/MediaVolume;)V
